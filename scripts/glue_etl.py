...
datasource0 = glueContext.create_dynamic_frame.from_catalog(
    ...
    table_name=args["raw_cloudtrail_table"],
...
applymapping1 = ApplyMapping.apply(
    ...
    mappings=[
        ...
        ("useridentity", "struct", "useridentity", "struct"),
...
datasink4 = glueContext.write_dynamic_frame.from_options(
    frame=relationalized3,
    connection_type="s3",
    connection_options={
        "path": args["results_bucket"] + "/parquet",
        "partitionKeys": ["account", "region", "year", "month", "day"]
    },
    format="parquet",
